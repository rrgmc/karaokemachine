...
const WALLPAPER_DIR: &str = "assets/wallpapers";
...
const WALLPAPER_PACK: &str = "default-wallpapers.zip";
...
fn shipped_wallpaper() -> Result<image::RgbaImage, String> {
...
fn hero_tick(song: &Song, view: &LyricView) -> u32 {
