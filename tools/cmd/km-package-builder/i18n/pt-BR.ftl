...
row-deleted = jogada fora
row-deleted-title = alguém jogou esta música fora; ela não está em nenhuma lista, busca ou pacote
...
songs-language-not = deixar de fora
...
chip-language-not = sem { $language }
